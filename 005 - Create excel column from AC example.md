...
Criteria: Technical manager data update; Given: A technical manager is already available in the contacts list on FinancePlan; When: the ISU edits it on FinancePlan; Then: Existing technical manager data on FinancePlan is overwritten by new data
