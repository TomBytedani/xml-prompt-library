...
### User / Role
- User type: `appUserType` (If multiple users are mentioned in the prompt, include all; ISU BOAD and ISU include their respective email addresses)
